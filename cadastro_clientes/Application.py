...
def insert_command():
    core.inserrt(app.txtNome.get(), app.txtSobrenome.get(), app.txtEmail.get(), app.txtCPF.get())
    view_command()

def update_command():
    core.update(selected[0], app.txtSobrenome.get(), app.txtEmail.get(), app.txtCPF.get())
    view_command()
...
def getSelectedRow(event):
    ...
    app.entSobrenome.insert(END, selected[1])
...
if __name__ == "__main__":
    ...
    app.dtnUpdate.configure(command=del_command)
